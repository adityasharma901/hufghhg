...
app.post('/buy-number', async (req, res) => {
    ...
    else if (server === 'nl') { apiUrl = 'https://5sim.net/v1/user/buy/activation/netherlands/virtual34/microsoft'; requiredBalance = 8; }
    else if (server === 'pl') { apiUrl = 'https://5sim.net/v1/user/buy/activation/poland/virtual59/microsoft'; requiredBalance = 15; }
